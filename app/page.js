  ...
  return (
    <main className="max-w-xl mx-auto">
      <section className="mt-12 [&_p]:mt-4">
        ...
        <p>For the most part we seek therapy in order to decrease our suffering. My commitment is to support you in achieving this goal. I believe that good therapy is deeply collaborative and  requires your sense of being safe and free from judgement as much as it does my compassion and training.</p>
      </section>
