  ...
  return (
    <main>
      ...
      <HeroSplit image={whyCounselling} alt="Why Counselling?">
        <Heading
          className="!text-sm uppercase !text-sea-pink-500 font-normal tracking-widest"
          level={1}
      ...
      <section className="px-8">
        <div className="grid w-full max-w-screen-xl p-8 mx-auto font-light text-white rounded-lg drop-shadow-xl gap-x-4 gap-y-8 md:grid-cols-2 lg:grid-cols-4 bg-gradient-to-t from-sea-pink-500 to-sea-pink-300">
          <div>
      ...
      <HeroSplit className="mt-4" image={contactMe} alt="Sarah Fysh">
      <Heading
          className="!text-sm uppercase !text-sea-pink-500 font-normal tracking-widest"
          level={2}
